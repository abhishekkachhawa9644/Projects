    ...
    <footer className="footer">
      <div className="container bottom_border">
        <div className="row">
          <div className="col-sm-4 col-md col-12">
            ...
            <p className="mb10">
            We are a creative film production studio, specializing in captivating stories, engaging videos, and cinematic experiences. Whether you're looking to collaborate or have a project in mind, we’d love to hear from you.
            </p>
            <p>
          ...
          <div className="col-sm-4 col-md col-12 logo">
           <img  src="src/components/logo.png" alt="pph img" />
          </div>
        </div>
      </div>
      ...
      <div className="container">
        ...
        <p className="text-center">
          Copyright @2024 |<a href="#"> Pinabh Production House Pvt. Ltd.</a>
        </p>
